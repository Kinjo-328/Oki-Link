  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case PackageComponentsRow:
            return PackageComponentsRow(data);
          case PartnersRow:
            return PartnersRow(data);
          case ExperienceShopsRow:
            return ExperienceShopsRow(data);
          case RentalShopsRow:
