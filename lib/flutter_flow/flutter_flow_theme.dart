...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF79C06E);
  late Color secondary = const Color(0xFF9EBF99);
  late Color tertiary = const Color(0xFFA0FF91);
  late Color alternate = const Color(0xFF1ABF00);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF6DBABF);
  late Color accent2 = const Color(0xFF836DBF);
  late Color accent3 = const Color(0xFFBF6D99);
  late Color accent4 = const Color(0xFFBFA46D);
